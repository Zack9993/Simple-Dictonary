...
List<DictonaryModel> dictonaryModelFromJson(String str) => List<DictonaryModel>.from(json.decode(str).map((x) => DictonaryModel.fromJson(x)));

String dictonaryModelToJson(List<DictonaryModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
